...
let fgclink = {key: {fromMe: false,"participant":"0@s.whatsapp.net", "remoteJid": "6282285357346@whatsapp.net"}, "message": {orderMessage: {itemCount: 9999999,status: 200, thumbnail: buffer, surface: 200, message: `${metadata.subject}`, orderTitle: 'memek', sellerJid: '0@s.whatsapp.net'}}, contextInfo: {"forwardingScore":999,"isForwarded":true},sendEphemeral: true}
he = `HELLO 👋 SELAMAT DATANG DI GROUP TOD 🗿${metadata.subject} @${num.split("@")[0]}\n\n${metadata.desc}`
let link = `https://youtube.com/c/HwModsWa857`
let buttons = [
{buttonId: `Darkx`, buttonText: {displayText: buttonvirus}, type: 1},
]
let buttonMessage = {
...
mentions: [num],
fileName: `HELLO 👋 SELAMAT DATANG DI GROUP TOD🗿${metadata.subject}`,
fileLength: 0,9,
caption: he,
footer: `© Darkx BOTZ☆`,
buttons: buttons,
...
let fgclink = {key: {fromMe: false,"participant":"0@s.whatsapp.net", "remoteJid": "6282285357346@whatsapp.net"}, "message": {orderMessage: {itemCount: 9999999,status: 200, thumbnail: buffer, surface: 200, message: `${metadata.subject}`, orderTitle: 'memek', sellerJid: '0@s.whatsapp.net'}}, contextInfo: {"forwardingScore":999,"isForwarded":true},sendEphemeral: true}
he = `SELAMAT TINGGAL COK🗿👋 ${metadata.subject} @${num.split("@")[0]}\n\n${metadata.desc}`
let link = `https://youtube.com/c/HwModsWa857`
let buttons = [
{buttonId: `Darkx`, buttonText: {displayText: buttonvirus}, type: 1},
]
...
jpegThumbnail:buffer,
mentions: [num],
fileName: `SEMOGA KHUSNUL KHOTIMAH 🙏 ${metadata.subject}`,
fileLength: 0,1,
caption: he,
footer: `© Darkx BOTZ`,
buttons: buttons,
